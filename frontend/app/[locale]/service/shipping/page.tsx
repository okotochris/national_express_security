...
const staticContent = {
  ...
  about: {
    title: "Connecting the World Through Reliable Shipping",
    description:
      "Our container shipping solutions provide efficient, secure, and sustainable movement of goods across continents, bridging suppliers and markets with unparalleled precision. Whether it’s full-container loads (FCL) for streamlined bulk transport, less-than-container loads (LCL) for cost-optimized smaller consignments, or specialized reefer and hazardous cargo handling, we deliver unmatched flexibility, speed, and reliability with every shipment. Backed by cutting-edge technology like AI-driven route optimization and blockchain-secured tracking, we ensure your cargo arrives on time, intact, and with minimal carbon footprint—empowering your business to thrive in a global economy.",
  },
  services: [
    {
      img: "/shipping2.jpg",
  ...
  network: {
    title: "A Trusted Network Across Continents",
    description:
      "We collaborate with top global carriers and port operators to ensure your goods move efficiently and safely — no matter where in the world they need to go.",
    cta: "Request a Quote",
  },
  ctaSection: {
    title: "Move Your Business Forward with Confidence",
    description:
    ...
    <>
      ...
      <section className="w-full bg-gradient-to-r from-emerald-700 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <Link href="/contact" className="inline-block bg-white text-emerald-700 px-6 py-3 rounded-md font-semibold hover:bg-slate-100 transition">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} className="relative w-full h-[300px] md:h-[400px]">
            <Image src="/shipping1.jpg" alt="Container Ship" fill className="object-cover rounded-2xl shadow-lg" priority />
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-24 bg-gradient-to-r from-blue-50 to-emerald-50 text-center">
        <div className="absolute inset-0 opacity-10">
          <Image src="/world-map.png" alt="Global shipping map" fill className="object-cover" />
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative max-w-4xl mx-auto">
          ...
          <Link href="/contact" className="bg-emerald-600 text-white px-6 py-3 rounded-md font-semibold hover:bg-emerald-700 transition">
      ...
      <section className="bg-emerald-700 py-16 text-center text-white">
        ...
        <Link href="/contact" className="bg-white text-emerald-700 px-6 py-3 rounded-md font-semibold hover:bg-slate-100 transition">
